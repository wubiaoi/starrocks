...
if [ ${BUILD_BE} -eq 1 ]; then
    ...
    cp -r -p /root/work/hadoop/share/hadoop/common ${STARROCKS_OUTPUT}/be/lib/hadoop/
    cp -r -p /root/work/hadoop/share/hadoop/hdfs ${STARROCKS_OUTPUT}/be/lib/hadoop/
    cp -r -p /root/work/hadoop/lib/native ${STARROCKS_OUTPUT}/be/lib/hadoop/
